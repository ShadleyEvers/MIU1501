...
// in simulator we redefine to format for Evers_Shadley_UtilityApp Developer console
...
{\
	NSString * exceptionName = [@"org.evers_shadley_utilityapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.evers_shadley_utilityapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIEvers_Shadley_UtilityAppNativeItemNone = -1, 
	UIEvers_Shadley_UtilityAppNativeItemSpinner = -2,
	UIEvers_Shadley_UtilityAppNativeItemProgressBar = -3,
	
	UIEvers_Shadley_UtilityAppNativeItemSlider = -4,
	UIEvers_Shadley_UtilityAppNativeItemSwitch = -5,
	UIEvers_Shadley_UtilityAppNativeItemMultiButton = -6,
	UIEvers_Shadley_UtilityAppNativeItemSegmented = -7,
	
	UIEvers_Shadley_UtilityAppNativeItemTextView = -8,
	UIEvers_Shadley_UtilityAppNativeItemTextField = -9,
	UIEvers_Shadley_UtilityAppNativeItemSearchBar = -10,
	
	UIEvers_Shadley_UtilityAppNativeItemPicker = -11,
	UIEvers_Shadley_UtilityAppNativeItemDatePicker = -12,
	
	UIEvers_Shadley_UtilityAppNativeItemInfoLight = -13,
	UIEvers_Shadley_UtilityAppNativeItemInfoDark = -14,
	
	UIEvers_Shadley_UtilityAppNativeItemDisclosure = -15,
	
	UIEvers_Shadley_UtilityAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Evers_Shadley_UtilityApp instances of
