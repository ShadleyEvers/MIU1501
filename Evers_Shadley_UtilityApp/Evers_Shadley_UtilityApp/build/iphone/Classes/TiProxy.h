...
//Rare exceptions to indicate a bug in the _evers_shadley_utilityapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Evers_Shadley_UtilityApp proxies.
 */
