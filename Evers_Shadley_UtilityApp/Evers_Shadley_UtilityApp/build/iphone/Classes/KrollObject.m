...
//@interface Evers_Shadley_UtilityAppObject : NSObject
//@end

@interface Evers_Shadley_UtilityAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Evers_Shadley_UtilityAppObject class]])
		{
			for (NSString *key in [[(Evers_Shadley_UtilityAppObject*)o modules] allKeys])
			{
