...
@interface Evers_Shadley_UtilityAppObject : KrollCoverageObject {
#else
@interface Evers_Shadley_UtilityAppObject : KrollObject {
#endif
@private
...
extern NSString * Evers_Shadley_UtilityApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Evers_Shadley_UtilityAppObject *_evers_shadley_utilityapp;
    KrollObject* console;
	BOOL shutdown;
