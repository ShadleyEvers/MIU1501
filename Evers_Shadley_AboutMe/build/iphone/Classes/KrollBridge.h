...
@interface Evers_Shadley_AboutMeObject : KrollCoverageObject {
#else
@interface Evers_Shadley_AboutMeObject : KrollObject {
#endif
@private
...
extern NSString * Evers_Shadley_AboutMe$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Evers_Shadley_AboutMeObject *_evers_shadley_aboutme;
    KrollObject* console;
	BOOL shutdown;
