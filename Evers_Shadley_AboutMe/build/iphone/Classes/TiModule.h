...
/**
 The base class for all Evers_Shadley_AboutMe modules
 */
...
/**
 Evers_Shadley_AboutMe Platform calls this method on startup.
 */
-(void)startup;

/**
 Evers_Shadley_AboutMe Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Evers_Shadley_AboutMe Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Evers_Shadley_AboutMe Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Evers_Shadley_AboutMe Platform calls this method on resume.
 @param sender The sender of the event.
 */
