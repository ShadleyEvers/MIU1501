...
// in simulator we redefine to format for Evers_Shadley_AboutMe Developer console
...
{\
	NSString * exceptionName = [@"org.evers_shadley_aboutme." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.evers_shadley_aboutme";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIEvers_Shadley_AboutMeNativeItemNone = -1, 
	UIEvers_Shadley_AboutMeNativeItemSpinner = -2,
	UIEvers_Shadley_AboutMeNativeItemProgressBar = -3,
	
	UIEvers_Shadley_AboutMeNativeItemSlider = -4,
	UIEvers_Shadley_AboutMeNativeItemSwitch = -5,
	UIEvers_Shadley_AboutMeNativeItemMultiButton = -6,
	UIEvers_Shadley_AboutMeNativeItemSegmented = -7,
	
	UIEvers_Shadley_AboutMeNativeItemTextView = -8,
	UIEvers_Shadley_AboutMeNativeItemTextField = -9,
	UIEvers_Shadley_AboutMeNativeItemSearchBar = -10,
	
	UIEvers_Shadley_AboutMeNativeItemPicker = -11,
	UIEvers_Shadley_AboutMeNativeItemDatePicker = -12,
	
	UIEvers_Shadley_AboutMeNativeItemInfoLight = -13,
	UIEvers_Shadley_AboutMeNativeItemInfoDark = -14,
	
	UIEvers_Shadley_AboutMeNativeItemDisclosure = -15,
	
	UIEvers_Shadley_AboutMeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Evers_Shadley_AboutMe instances of
