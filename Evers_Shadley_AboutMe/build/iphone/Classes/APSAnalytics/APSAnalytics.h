 ...
 * to send analytic data that can be viewed on the Evers_Shadley_AboutMe Dashboard.
 *
 * For information on getting started with Evers_Shadley_AboutMe Platform Services,
