...
//@interface Evers_Shadley_AboutMeObject : NSObject
//@end

@interface Evers_Shadley_AboutMeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Evers_Shadley_AboutMeObject class]])
		{
			for (NSString *key in [[(Evers_Shadley_AboutMeObject*)o modules] allKeys])
			{
