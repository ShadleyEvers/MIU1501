...
//@interface Evers_Shadley_InfoAppObject : NSObject
//@end

@interface Evers_Shadley_InfoAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Evers_Shadley_InfoAppObject class]])
		{
			for (NSString *key in [[(Evers_Shadley_InfoAppObject*)o modules] allKeys])
			{
