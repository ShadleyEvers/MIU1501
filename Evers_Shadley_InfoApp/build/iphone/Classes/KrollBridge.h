...
@interface Evers_Shadley_InfoAppObject : KrollCoverageObject {
#else
@interface Evers_Shadley_InfoAppObject : KrollObject {
#endif
@private
...
extern NSString * Evers_Shadley_InfoApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Evers_Shadley_InfoAppObject *_evers_shadley_infoapp;
    KrollObject* console;
	BOOL shutdown;
