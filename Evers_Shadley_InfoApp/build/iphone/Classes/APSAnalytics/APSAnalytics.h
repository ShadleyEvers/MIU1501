 ...
 * to send analytic data that can be viewed on the Evers_Shadley_InfoApp Dashboard.
 *
 * For information on getting started with Evers_Shadley_InfoApp Platform Services,
