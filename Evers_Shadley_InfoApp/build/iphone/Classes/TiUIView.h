...
/**
 Base class for all Evers_Shadley_InfoApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Evers_Shadley_InfoApp view hierarchy (such as wrapped iOS UIViews) was touched.
