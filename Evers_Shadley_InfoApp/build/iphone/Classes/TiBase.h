...
// in simulator we redefine to format for Evers_Shadley_InfoApp Developer console
...
{\
	NSString * exceptionName = [@"org.evers_shadley_infoapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.evers_shadley_infoapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIEvers_Shadley_InfoAppNativeItemNone = -1, 
	UIEvers_Shadley_InfoAppNativeItemSpinner = -2,
	UIEvers_Shadley_InfoAppNativeItemProgressBar = -3,
	
	UIEvers_Shadley_InfoAppNativeItemSlider = -4,
	UIEvers_Shadley_InfoAppNativeItemSwitch = -5,
	UIEvers_Shadley_InfoAppNativeItemMultiButton = -6,
	UIEvers_Shadley_InfoAppNativeItemSegmented = -7,
	
	UIEvers_Shadley_InfoAppNativeItemTextView = -8,
	UIEvers_Shadley_InfoAppNativeItemTextField = -9,
	UIEvers_Shadley_InfoAppNativeItemSearchBar = -10,
	
	UIEvers_Shadley_InfoAppNativeItemPicker = -11,
	UIEvers_Shadley_InfoAppNativeItemDatePicker = -12,
	
	UIEvers_Shadley_InfoAppNativeItemInfoLight = -13,
	UIEvers_Shadley_InfoAppNativeItemInfoDark = -14,
	
	UIEvers_Shadley_InfoAppNativeItemDisclosure = -15,
	
	UIEvers_Shadley_InfoAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Evers_Shadley_InfoApp instances of
